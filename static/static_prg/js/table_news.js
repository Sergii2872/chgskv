// Скрипт отрисовки таблицы плагина datatables.net для таблицы БД наименования валют News, подключен в blok2/balance_Currency.html
...
// методом ajax обмениваемся данными с функцией list класса News_ViewSet в blok2/views.py
...
let table = $('#datatables').DataTable({
    ...
    buttons: [
        ...
        },
        {
            ...
            title: 'Справочник новостей', // заголовок печати, если не задаем то печатает title html страницы
