                 ...
                 if (data){
                    if (data.vreg == '1' || data.vreg == '3'){
                       ...
                       //window.location.replace("https://"+location.host); /* перегружаем домашнюю страницу */
                        ...
                        if (data.vreg == '2'){
                            //popup('#box1');
                            $.alert('Вы зарегистрированы! Вам отправлено письмо на почту для подтверждения регистрации!');
                        }
                        if (data.vreg == '4'){
                            //popup('#box2');
                            $.alert('Не корректный Email, номер телефона или подтверждающий пароль!');
                        }
                        if (data.vreg == '5'){
                            //popup('#box3');
                        ...
                        if (data.vreg == '6'){
                            //popup('#box4');
                            $.alert('Такой login уже зарегистрирован!');
                        }
                        if (data.vreg == '7'){
                            //popup('#box5');
                            $.alert('Пользователь с таким логином и паролем еще не активирован! Если вы не получили письмо на почту для подтверждения регистрации свяжитесь с администратором');
                        }
                    }
